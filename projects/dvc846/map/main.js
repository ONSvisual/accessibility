...
setLegend()
		...
		d3.select("#keyvalue")
			...
			d3.select("#keyvaluehidden")
						.html("In " + areanmhc + " there have been " +
								...
								dataApr[areacd] + " deaths in April. And there have been " +
								dataMay[areacd]+  " deaths in May.")
	...
	function setLegend() {
		...
		fieldset = d3.select("#keydiv").append("fieldset")
		fieldset.append("legend").attr("class", "visuallyhidden").text("Choose your data")

		legend = fieldset.selectAll('g')
