...
if(Modernizr.webgl) {
	...
	function ready (error, data, config, geog){
		...
		if(dvc.varlabels.length > 1)	{
			...
			d3.select("#topNav").style("height","0px")	
		}
		//set title of page
		...
		function setButtons() {
			d3.select("#play").on("click", function() {
				...
				d3.select("#pause").on("click", function(){
						...
						d3.select("#playImage").attr("src","images/play.png");
						setButtons();
		...
		function createKey(config){
			...
			if(mobile == false) {
				...
				var yAxis = d3.axisLeft(y)
					...
					.tickFormat(displayformat);
				
				var xAxisTime = d3.axisBottom(x)
					.tickSize(5)
					.tickValues([dvc.timepoints[0], dvc.timepoints[(dvc.timepoints.length-1)/2],  dvc.timepoints[dvc.timepoints.length-1]])
					.tickFormat(legendformat);
					
				var linedata2 = [["1997",10807],["1998",11191],["1999",11557],["2000",12321],["2001",12779],["2002",13137],["2003",13464],["2004",13939],["2005",14427],["2006",15007],["2007",15644],["2008",16074],["2009",16344],["2010",16353],["2011",16570],["2012",17310],["2013",17866],["2014",18297],["2015",19234],["2016",19322],["2017",19514]];
				...
				svgkey.append("g").attr("id","timeaxis")
					.attr("transform", "translate(60," + (20 + keyheight) + ")")
					.attr("font-weight","400")
					.style("font-family","'Open Sans'")
					.style("font-size","12px")
					.call(xAxisTime)
