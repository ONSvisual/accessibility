...
if(Modernizr.webgl) {
		...
		function createKey(config){
			...
			if(mobile == false) {
				...
				var xAxisTime = d3.axisBottom(x)
					.tickSize(5)
					.tickValues([dvc.timepoints[0], dvc.timepoints[4],dvc.timepoints[8], dvc.timepoints[12], dvc.timepoints[16], dvc.timepoints[dvc.timepoints.length-1]])
	...
	d3.select('body').append('img').attr("src","images/fallback.png");
