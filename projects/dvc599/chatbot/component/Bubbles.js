...
function Bubbles(container, self, options) {
  ...
  animationTime = options.animationTime || 400 // how long it takes to animate chat bubble, also set in CSS
    ...
    inputText.addEventListener("keypress", function(e) {
      ...
      if (e.keyCode == 13) {
        ...
        !lastBubble.classList.contains("reply-freeform")
          ...
          : false
        addBubble(
          '<span class="bubble-button bubble-button-active bubble-pick">' + this.value + "</span>",
          function() {},
  ...
  this.reply = function(turn) {
    ...
    if (turn.reply !== undefined) {
      ...
      for (var i = 0; i < turn.reply.length; i++) {
        ;(function(el, count) {
          questionsHTML +=
            '<span class="bubble-button bubble-button-active" style="animation-delay: ' +
  ...
  this.answer = function(key, content) {
    ...
    if (_convo[key] !== undefined && content !== undefined) {
      interactionsSave(
        '<span class="bubble-button bubble-button-active reply-pick">' + content + "</span>",
        "reply reply-pick"
      )
    }
  }
  ...
  var addBubble = function(say, posted, reply, live) {
    ...
    bubbleQueue = setTimeout(function() {
      ...
      bubble.style.width = say.includes("<img src=")
        ? "100%"
        : bubble.style.width
      // bubble.style.height = say.includes("<img src=")
      //   ? "600px"
      //   : bubble.style.height
