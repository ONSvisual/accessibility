if (Modernizr.inlinesvg) {
  ...
  function ready(error, dataexports, dataimports, geog) {
    ...
    function highlightcountry(countrycode) {
      ...
      d3.select("#accessibility p").text("The total services imported from " + countryname + " in " + dvcyear + " was  £" + d3.format(",")(importval * 1000000) + ". The total services exported to " + countryname + " in " + dvcyear + " was £" + d3.format(",")(exportval * 1000000) + ".")
