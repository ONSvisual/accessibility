...
function barchartstart(){
    ...
    if (parseInt(d3.select("#chartsnsparks").style("width")) < 600) {
      ...
      tickvalues=[new Date(1999, 0, 1), new Date(2001, 0, 1),
                  new Date(2003, 0, 1), new Date(2005, 0, 1),
                  new Date(2007, 0, 1), new Date(2009, 0, 1),
                  new Date(2011, 0, 1), new Date(2013, 0, 1),
