...
function highlightcountry(countrycode) {
    ...
    //Update labels
    d3.select("#tradewith").html("UK trade with " + countryname + " <span style='font-weight:300'>2017</span>")
...
function unhighlightcountry(countrycode) {
  ...
  //Update labels
  d3.select("#tradewith").html("UK Trade in Goods <span style='font-weight:300'>2017</span>")
...
function createBarcode(){
  ...
  barcodeexports = barcodeexports.filter(function(d){return d.CountryName!="Whole World"})
    ...
    barcodeLabels = d3.select("#barcode")
		...
		.html("<span style='font-weight:bold'>Trade in goods</span> 2017")
		.append("div")
